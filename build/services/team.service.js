        ...
        execute: function() {
            TeamService = (function () {
                ...
                TeamService.prototype.getTeamByName = function (TeamName) {
                    var endpointUrl = Global.CARETRAIL_ENDPOINT + '/team/getTeamByName/' + TeamName;
                ...
                TeamService.prototype.leaveTeam = function (removeUserModel) {
                    var endpointUrl = Global.CARETRAIL_ENDPOINT + 'people/leaveTeam';
                    var header = new http_1.Headers({
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
                        'Authorization': sessionStorage.getItem("bearerToken"),
                ...
                TeamService.prototype.getTeamNamesImOn = function (userEmailAddress) {
                    var endpointUrl = Global.CARETRAIL_ENDPOINT + 'people/myTeams/' + userEmailAddress + '/';
                    var header = new http_1.Headers({
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
                        'Authorization': sessionStorage.getItem("bearerToken"),
                ...
                TeamService.prototype.getTeamMembersNames = function (teamName) {
                    var endpointUrl = Global.CARETRAIL_ENDPOINT + '/team/getMembers/' + teamName;
                    var header = new http_1.Headers({
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
                        'Authorization': sessionStorage.getItem("bearerToken"),
                ...
                TeamService.prototype.getTeamPatientsNames = function (teamName) {
                    var endpointUrl = Global.CARETRAIL_ENDPOINT + '/team/getPatients/' + teamName;
                    var header = new http_1.Headers({
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
                        'Authorization': sessionStorage.getItem("bearerToken"),
